...
public class PendingPaymentFragment extends Fragment implements BackpressedListener{
    ...
    private void back() {
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    navController.navigate(R.id.action_pendingPaymentFragment_to_adminPanelFragment);
